 ...
 * @return mixed
 */
function dsp0_return_clean_breakpoint_id(\Drupal\breakpoint\Breakpoint $breakpoint) {
 ...
 */
function dsp0_return_layouts($theme) {
 ...
 * @return int|string
 */
function dsp0_find_layout_provider($theme) {
 ...
 */
function dsp0_return_active_layout() {
  ...
  $layoutProvider = dsp0_find_layout_provider($theme);
  //dpm($layoutProvider);
